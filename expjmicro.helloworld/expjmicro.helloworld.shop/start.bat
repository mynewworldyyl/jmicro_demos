title expjmicro.helloworld.shop
java ^
...
-jar  %MAVEN_RESP_HOME%\cn\expjmicro\expjmicro.helloworld.shop\0.0.5-SNAPSHOT\expjmicro.helloworld.shop-0.0.5-SNAPSHOT-with-core.jar ^
