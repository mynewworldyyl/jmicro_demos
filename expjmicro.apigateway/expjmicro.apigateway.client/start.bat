title expjmicro.helloworld.client
java ^
...
-jar  %MAVEN_RESP_HOME%\cn\expjmicro\expjmicro.helloworld.client\0.0.5-SNAPSHOT\expjmicro.helloworld.client-0.0.5-SNAPSHOT-with-core.jar ^
